"""GATE C2 — does xgrammar compile the real schema, and is EMPTY reachable?
    ...
    /Users/evancanty/vn-shared/.venv/bin/python -m mnemonica.extract.c2_gate
...
from mnemonica.extract.grammar import GrammarCache  # noqa: E402
from mnemonica.extract.runner import DEV_MODEL  # noqa: E402
from mnemonica.extract.schema import TurnExtraction, VisitExtraction  # noqa: E402
...
def _live(cache) -> bool:
    ...
    from mnemonica.extract.runner import Extractor
